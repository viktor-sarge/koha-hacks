...
SQL - PUT THIS AS A PUBLIC REPORT

SELECT biblio.biblionumber, author, title, isbn FROM biblio
...
$("#coverwidget-newBooks").ready(function () {
    var json_url = "http://localhost:8080/cgi-bin/koha/svc/report?id=1"; //Change to your URL + the id of your public SQLreport (see above)
